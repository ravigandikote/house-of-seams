...
// Customers are captured automatically from bookings, custom design
// requests, and newsletter signups — this admin resource is list-only
// (plus delete via [id] for data hygiene).
